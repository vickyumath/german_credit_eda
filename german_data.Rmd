...
```{r}
ggplot(my_data,aes(x=saving_bond))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=personal_status))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=check.acc.))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=cred_hist.))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=Purpose))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=other_debtors))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=property.))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=other_install_plans))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=housing.))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x= dependents))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x= job))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
ggplot(my_data,aes(x=telephone))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
...
```{r}
ggplot(my_data,aes(x=status))+geom_bar(stat = "count",fill= "cornflowerblue",col="blue")+geom_text(stat='count',aes(label = ..count..),vjust = -1)
```
...
```{r}
par(mfrow=c(1,4))
ggplot(my_data,aes(x=saving_bond,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=check.acc.,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=cred_hist.,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x= Purpose,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=personal_status,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=other_debtors,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=property.,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=other_install_plans,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=housing.,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=job,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=telephone,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=foreign_worker,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
...
ggplot(my_data,aes(x=employ_since,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=Installment_rate,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=residence_since,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=no.of_exist_cred,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
ggplot(my_data,aes(x=dependents,fill= status))+geom_bar(stat = "count",position = "dodge")+facet_grid(~status)
```
